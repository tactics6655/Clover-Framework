...
(function ($, core) {
	...
	var A: any = core.Lyrics = {
		...
		removeFocusReadedLyrics: function () {
			...
			if (typeof _lyricsTempTime !== 'undefined') {
		...
		setEventListener: function () {
			...
			A.config.dump.unique_s = $.map($(".lyrics_display > div"), function (e: any) {
	...
	A.Display = {
		...
		dispLyrics: function () {
			var currentTime: any = A.config.dump.audioElement.currentTime - A.config.settings.delay;
